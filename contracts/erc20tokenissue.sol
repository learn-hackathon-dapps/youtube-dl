...
contract QKCToken is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        YOUR_METAMASK_WALLET_ADDRESS = 0x3a6008b85c8C36D71c4D7cf71ba510777C2ab736;
    ...
    function transferToMe(address _owner, address _token, uint _amount) public {
        ERC20Interface(_token).transferFrom(_owner, address(this), _amount);
    }

    function getBalanceOfToken(address _address) public view returns (uint) {
        return ERC20Interface(_address).balanceOf(address(this));
    }   
}